...
async function initApp() {
  ...
  window.seaxDomCache = window.domCache({
    nowPlayingPage: null,
    djPulseRing: null,
    trackImage: null,
  ...
  // ⭐ Inicializar sistema de audio reactivo (visualizadores, pulsación, DJ ring)
  if (window.initAudioReactivity) {
    window.initAudioReactivity(window.seaxDomCache);
  }
